...
export default function App() {
  ...
  useEffect(() => {
    ...
    // Scroll listener for header background and active section indicator
    const handleScroll = () => {
  ...
  // 3D Perspective Tilt on Mouse Movement over Hero Graphic
  ...
  return (
    <div style={{ position: 'relative', width: '100%', minHeight: '100vh', overflow: 'hidden' }}>
      ...
      {/* Smooth Flowing WebGL Background (matching reference implementation) */}
      ...
      {/* Main Page Layout Wrapper at zIndex 2 */}
      <div style={{ position: 'relative', zIndex: 2 }}>
        ...
        <section id="hero" className="section container" style={{ paddingBottom: '40px' }}>
          <div className="hero-wrapper fade-in-up">
            ...
            <div 
              ...
              style={{ transition: 'transform 0.1s ease-out', cursor: 'pointer' }}
            >
        ...
        <section id="experience" className="section container reveal">
          ...
          <div className="timeline">
            ...
            <div className="timeline-item right">
              ...
              <ScrollReveal style="fade-right" delay={150}>
            ...
            <div className="timeline-item left">
              <div className="timeline-dot"></div>
              <ScrollReveal style="fade-left" delay={300}>
                <div className="timeline-card glass-panel">
        ...
        <section id="skills" className="section container reveal">
          ...
          <div className="skills-grid">
            ...
            <ScrollReveal style="scale" delay={150}>
              <div className="skills-category glass-panel">
            ...
            <ScrollReveal style="scale" delay={300}>
              <div className="skills-category glass-panel">
